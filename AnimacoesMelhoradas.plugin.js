 ...
 * @author santozrx
 * @authorLink https://github.com/Santozrlk
 * @invite AsVRsJarMM
 * @version 1.0.3
  ...
  /**{
    ...
    },*/
    {
      ...
      items: [
        ...
        'Correção ao carregar o plugin e dar erro em ChangeLogs.'
      ]
    },
    {
      type: 'progress',
      title: 'Fique ligado',
      items: [
        'Grandes mudanças estão em andamento...'
      ]
    }
  ]
}
...
module.exports = class BetterAnimations {
  ...
  getSettingsPanel () {
    ...
    const containerTypes = [
      ...
      {
        key: 'slipDown',
        name: 'Deslize para baixo'
      },
      {
        key: 'slipLeft',
        name: 'Deslize para a esquerda'
      },
      {
        key: 'slipRight',
        name: 'Deslize para a direita'
      },
      {
        key: 'slideUp',
        name: 'Deslize para cima'
      },
      {
        key: 'slideDown',
        name: 'Deslize para baixo'
      ...
      {
        key: 'scaleUp',
        name: 'Escalar verticalmente'
      },
      {
        key: 'scaleDown',
        name: 'Reduzir a escala'
      },
      {
        key: 'scaleLeft',
        name: 'Escala à esquerda'
      },
      {
        key: 'scaleRight',
        name: 'Dimensionar à direita'
      },
      {
        key: 'fade',
        name: 'Desvanecer'
      ...
      {
        key: 'scaleForwards',
        name: 'Escalar para a frente'
      },
      {
        key: 'scaleBackwards',
        name: 'Reduzir para trás'
      },
      {
        key: 'scaleChange',
        name: 'Mudança de escala'
      },
    ]
    ...
    const revealTypes = [
      ...
      },
      {
        ...
        name: 'Escalar para a frente Dependente lateral'
      },
      {
        key: 'scaleBackwardsSide',
        name: 'Reduzir para trás Dependente do lado'
      },
      {
        key: 'rotateForwardsLeft',
        name: 'Girar para a frente para a esquerda'
      },
      {
        key: 'rotateForwardsRight',
        name: 'Girar para a direita'
      },
      {
        key: 'rotateBackwardsLeft',
        name: 'Girar para trás para a esquerda'
      },
      {
        key: 'rotateBackwardsRight',
        name: 'Girar para trás para a direita'
      },
    ]
    ...
    const positions = [
      { label: 'Topo', value: 'bottom' },
      { label: 'Fundo', value: 'top' },
      { label: 'Esquerda', value: 'right' },
      { label: 'Direita', value: 'left' }
    ]
      ...
      return {
        ...
        settings: [
          ...
          ...(explicitPosition ? [
            {
              ...
              id: 'position',
              name: 'Lado',
              note: 'Define o lado para animações dependentes do lado.',
          ...
          ] : []),
          {
            ...
            id: 'easing',
            name: 'Easing',
            note: 'As funções de easing podem ser visualizadas em www.easings.net',
    ...
    const element = UI.buildSettingsPanel({
      ...
      settings: [
        buildSection(
          'guild',
          'Animações de Guilda',
          { enableText: 'Ativar animação de troca de guilda' }
        ),
        buildSection(
          'channel',
          'Animações de canal',
          { enableText: 'Ativar animação de troca de canal' }
        ),
        buildSection(
          'settings',
          'Configurações Animações',
          { enableText: 'Ativar animação de alternância de seções de configurações' }
        ),
        buildSection(
          'messages',
          'Animações de mensagens',
          { enableText: 'Ativar a animação de revelação de nova mensagem', reveal: true, explicitPosition: true }
        ),
        buildSection(
          'popouts',
          'Pop-outs, menus de contexto e animações de dicas de ferramentas',
          { enableText: 'Ativar pop-outs, menus de contexto e animações de dicas de ferramentas', reveal: true }
        ),
        buildSection(
          'expressionPicker',
          'Animações do seletor de expressões',
          { enableText: 'Ativar animação de alternância de seções do seletor de expressão' }
        )
      ]
    })
